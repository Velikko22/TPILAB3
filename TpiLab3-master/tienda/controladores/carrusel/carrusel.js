...
`
    <div class="slider-container">
        <div class="slide active">
            <img src="/img/nuevas/slider/imagen1.webp" alt="Imagen 1" style="width:100%; height:100%; object-fit:cover;">
        </div>
        <div class="slide">
            <img src="/img/nuevas/slider/imagen2.webp" alt="Imagen 2" style="width:100%; height:100%; object-fit:cover;">
        </div>
        <div class="slide">
            <img src="/img/nuevas/slider/imagen3.webp" alt="Imagen 3" style="width:100%; height:100%; object-fit:cover;">
        </div>
